...
$DOCKER_IMAGE_NAME="twist_loop"

# Nom du conteneur Docker
$DOCKER_CONTAINER_NAME="twist_loop_container"
...
docker run -it --name $DOCKER_CONTAINER_NAME -e DISPLAY=host.docker.internal:0 --network host $DOCKER_IMAGE_NAME
