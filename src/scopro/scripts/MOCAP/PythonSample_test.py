...
import sys
import time
from NatNetClient_test import NatNetClient
import DataDescriptions
import MoCapData_test as MoCapData
...
def print_commands(can_change_bitstream):
    ...
    outstring += "  m  print_level = 2000 show data description and every 2000th mocap frame data\n"
        ...
        if len(inchars)>0:
            ...
            if c1 == 'h' :
                ...
                if c1 == 'l':
                    ...
                    print_level = streaming_client.set_print_level(2000)
